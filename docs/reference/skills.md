...
1. No arguments — calls [`pm_next`](mcp-tools.md#pm_nexttext-append-clear-prefix), restates the note in a sentence or two, proposes the first concrete step it implies, and asks whether to start
