...
11. **Check downstream dependencies**: After completing, notify about tasks that were waiting on this one
    - "Task US-PRJ-2-1 is now unblocked and ready to work"
12. Summarize what was done, files changed, tests run
13. Suggest next action: "Check the board for more work: `/pm board`"
