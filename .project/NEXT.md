...
2. The MCP server was reinstalled from the tree on 2026-09-06 (HEAD 06b16f1). Restart Claude Code if this session predates that, so pm_next and the store guards are live.
